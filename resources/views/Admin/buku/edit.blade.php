      ...
      <div class="card-body">
       <form action="{{ route('Buku.update', $Buku->id) }}" method="POST">
        ...
        <div class="row mb-3">
         ...
         <div class="col-sm-8">
          <input type="text" name="kode_buku" id="kode_buku" value='{{ $Buku->kode_buku }}' readonly class="form-control">
         </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
         ...
         <div class="col-sm-8">
          <input type="text" class="form-control" name="penulis_buku" id="penulis_buku" value='{{ $Buku->penulis_buku }}' >
         </div>
        </div>
        <div class="row mb-3">
         <label class="col-sm-4 col-form-label">Penerbit Buku</label>
         <div class="col-sm-8">
          <input type="text" class="form-control" name="penerbit_buku" id="penerbit_buku" value='{{ $Buku->penerbit_buku }}' >
         </div>
        </div>
        <div class="row mb-3">
         <label class="col-sm-4 col-form-label">Tahun Penerbitan</label>
         <div class="col-sm-8">
          <input type="text" class="form-control" name="tahun_penerbitan" id="tahun_penerbitan" value='{{ $Buku->tahun_penerbitan }}' >
         </div>
        </div>
        <div class="row mb-3">
         ...
         <div class="col-sm-8">
          <select name="id_rak" id="id_rak" class="form-control">
           ...
           @foreach ($rak as $r)
           <option value="{{ $r->id }}" {{ $Buku->id_rak == $r->id ? 'selected' : '' }}>
            {{ $r->nama_rak }}
           </option>
           @endforeach
          </select>
